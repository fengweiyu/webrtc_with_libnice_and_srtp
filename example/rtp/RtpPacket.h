...
public:
    ...
    virtual int Packet(T_RtpPacketParam *i_ptParam,unsigned char *i_pbFrameBuf,int i_iFrameLen,unsigned char **o_ppPackets,int i_iPacketsMaxNum,int *o_aiEveryPacketLen,int i_iRtpPacketType=RTP_PACKET_TYPE_H264);
...
public:
    ...
    virtual int Packet(T_RtpPacketParam *i_ptParam,unsigned char *i_pbNaluBuf,int i_iNaluLen,unsigned char **o_ppPackets,int i_iPacketsMaxNum,int *o_aiEveryPacketLen,int i_iRtpPacketType=RTP_PACKET_TYPE_H264);
...
public:
    H264NALU();
    virtual ~H264NALU();
    int Packet(T_RtpPacketParam *i_ptParam,unsigned char *i_pbNaluBuf,int i_iNaluLen,unsigned char **o_ppPackets,int i_iPacketsMaxNum,int *o_aiEveryPacketLen,int i_iRtpPacketType=RTP_PACKET_TYPE_H264);
